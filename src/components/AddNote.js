...
export default function AddNote() {
  ...
  return (
    <div className=' flex flex-col px-5 pb-5 pt-20 md:px-20'>
        ...
        <div className="bg-white flex flex-col justify-center items-center md:justify-start md:items-start">
            ...
            <form action="" method='post'  className=' w-full'>
                <div className='flex py-2 flex-col justify-start w-full'>
                    ...
                    <input type="text" placeholder='Enter Title...' className=" md:w-[50%]  bg-white border border-gray-600  rounded-lg text-base  px-4 py-2 shadow-sm focus:outline-none focus:border-blue-700 focus:ring-2 focus:ring-blue-100 " name='title' onChange={handleChange} />
               
                    <span className=' pt-4 font-bold text-sm md:text-base rounded-l-lg pb-1 px-2'>Description</span>
                    <textarea type="text" rows='4' placeholder='Enter Description...' className="md:w-[50%] bg-white border border-gray-600 rounded-lg text-base  px-4 py-2 shadow-sm focus:outline-none focus:border-blue-700 focus:ring-2 focus:ring-blue-100 " name='desc' onChange={handleChange}></textarea>
                
                    <span className=' pt-4 font-bold text-sm md:text-base rounded-l-lg pb-1 px-2'>Enter Tag</span>
                    <input type="text" placeholder='Enter Tag...' className="md:w-[50%]  bg-white border border-gray-600 rounded-lg text-base  px-4 py-2 shadow-sm focus:outline-none focus:border-blue-700 focus:ring-2 focus:ring-blue-100 " name='tag'  onChange={handleChange}/>
