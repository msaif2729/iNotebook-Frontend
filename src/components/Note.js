  ...
  return (
    <div className=' pb-2 py-5 pt-20 '>
        <div className=" justify-between flex px-3 md:px-20 ">
            ...
            <div className={`flex justify-center items-center ${context.udata.success?"block":"hidden"}`}>
        ...
        <div className={`${context.udata.success?"hidden":"block"} flex flex-col justify-center items-center pt-3 transition-all duration-100`}> 
        ...
        <div className={`${context.udata.success?"block":"hidden"} flex flex-wrap justify-center items-center pt-3 transition-all duration-100`}>
